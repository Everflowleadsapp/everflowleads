      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-12 leading-relaxed">
            Join 300+ UK businesses generating consistent leads with AI. 
            <br />
            Get your first qualified leads within 14 days or your money back.
          </p>
          
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-white/20 mb-8">
            <h3 className="text-2xl font-bold text-white mb-6">
              Get Your Free Lead Generation Strategy Call
            </h3>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <Input
                ...
                required
                className="flex-1 bg-white/20 border-white/30 text-white placeholder:text-white/60 rounded-full px-6 py-3"
              />
              <Button 
                type="submit"
                size="lg" 
                className="bg-white text-blue-600 hover:bg-gray-100 font-bold px-8 py-3 rounded-full transition-all duration-300 transform hover:scale-105 shadow-xl"
              >
                Book Free Call
              </Button>
            </form>
